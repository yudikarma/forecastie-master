...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    private void aboutDialog() {
        AlertDialog.Builder alert = new AlertDialog.Builder(this);
        alert.setTitle("Monitoring Jemuran");
        final WebView webView = new WebView(this);
        String about = "<p>1.0.0</p>" +
                "<p>Sebuah Project Akhir untuk membantu pengguna melihat keadaan jemuran disaat berada diluar rumah</p>" +
                "<p>Developed by <a href='mailto:adeirwandaa@gmail.com'>Ade Irwanda</a></p>" +
                "<p>visit my site : <a href='https://adeirwandaa.blogspot.co.id/'>adeBlog's</a>" +
                "<p>Instagram : <a href='https://instagram.com/adeirwandaa'>my instagram </a></p>"+
                " <p>twitter : <a href='http://www.twitter.com/adeirwandaa'>my twitter</a> </P>";
